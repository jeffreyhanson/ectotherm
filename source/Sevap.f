...
c    Copyright 2003 Warren Porter All rights reserved.
      ...
      REAL AMASS,AMTFUD,ATOT,BP,CP,CUTFA
      REAL DENAIR,DB,DP,DELTAR,DEPSUB,E,EMISAN,ESAT,EXTREF
      REAL FATOSK,FATOSB,Flshcond,GEVAP,gwatph
      Real HD,HDforc,HDfree,HTOVPR
      REAL O2MAX,O2MIN,PATMOS,PCTEYE,PSTD,PTCOND
      REAL QCOND,QCONV,Qsevap,QIRIN,QIROUT,QMETAB,QRESP,QSOLAR
      REAL R,RH,RELHUM,RQ,RW,SIG,SkinW,SPHEAT,SUBTK
      REAL TA,TAIR,TC,TDIGPR,TIME,Tlung,TMAXPR,TMINPR,Tskin,Tsubst
      REAL TR,TVIR,TVINC,V,VD,VDAIR,VDSURF,VEL,tbask,temerge
      REAL WATER,WB,WCUT,WEVAP,WEYES,WRESP,WTRPOT,Xtry
