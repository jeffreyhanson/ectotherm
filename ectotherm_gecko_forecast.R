...
TMINPR<-15.0 # degrees C, voluntary thermal minimum (lower body temperature for foraging)
TBASK<-15.# degrees C, minimum basking temperature 
TEMERGE<-6.0 # degrees C, temperature at which animal will move to a basking site 
...
write.csv(forecast,"gecko_forecast.csv")
