...
TMAXPR<-37 # degrees C, voluntary thermal maximum (upper body temperature for foraging)
TMINPR<-34.0 # degrees C, voluntary thermal minimum (lower body temperature for foraging)
TBASK<-23.1# degrees C, minimum basking temperature 
