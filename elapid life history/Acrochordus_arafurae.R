...
TMAXPR<-32 # degrees C, voluntary thermal maximum (upper body temperature for foraging and also burrow depth selection) # based on Table 2, Shine, R. and R. Lambeck (1985). "A Radiotelemetric Study of Movements, Thermoregulation and Habitat Utilization of Arafura Filesnakes (Serpentes: Acrochordidae)." Herpetologica 41(3): 351-361.
TMINPR<-25# degrees C, voluntary thermal minimum (lower body temperature for foraging) # Table 2, Shine, R. and R. Lambeck (1985). "A Radiotelemetric Study of Movements, Thermoregulation and Habitat Utilization of Arafura Filesnakes (Serpentes: Acrochordidae)." Herpetologica 41(3): 351-361.
TBASK<-25 # degrees C, minimum basking temperature # Table 2, Shine, R. and R. Lambeck (1985). "A Radiotelemetric Study of Movements, Thermoregulation and Habitat Utilization of Arafura Filesnakes (Serpentes: Acrochordidae)." Herpetologica 41(3): 351-361.
TEMERGE<-25 # degrees C, temperature at which animal will move to a basking site # Table 2, Shine, R. and R. Lambeck (1985). "A Radiotelemetric Study of Movements, Thermoregulation and Habitat Utilization of Arafura Filesnakes (Serpentes: Acrochordidae)." Herpetologica 41(3): 351-361.
ctmax<-41.7  # degrees C, critical thermal maximum (animal will die if ctkill = 1 and this threshold is exceeded) # Table 2, Shine, R. and R. Lambeck (1985). "A Radiotelemetric Study of Movements, Thermoregulation and Habitat Utilization of Arafura Filesnakes (Serpentes: Acrochordidae)." Herpetologica 41(3): 351-361.
ctmin<-25 # degrees C, critical thermal minimum (used by program to determine depth selected when inactive and burrowing) Lillywhite, H. B. (1980). "Behavioral Thermoregulation in Australian Elapid Snakes." Copeia 1980(3): 452-458.
...
TPREF<-30 # preferred body temperature (animal will attempt to regulate as close to this value as possible) # Table 2, Shine, R. and R. Lambeck (1985). "A Radiotelemetric Study of Movements, Thermoregulation and Habitat Utilization of Arafura Filesnakes (Serpentes: Acrochordidae)." Herpetologica 41(3): 351-361.
DELTAR<-0.1 # degrees C, temperature difference between expired and inspired air
skinwet<-0.35 # %, of surface area acting like a free water surface (e.g. most frogs are 100% wet, many lizards less than 5% wet) # guess
...
shdburrow<-0 #
mindepth<-6 # minimum depth (soil node) to which animal can retreat if burrowing, Fig. 3, Shine, R. and R. Lambeck (1985). "A Radiotelemetric Study of Movements, Thermoregulation and Habitat Utilization of Arafura Filesnakes (Serpentes: Acrochordidae)." Herpetologica 41(3): 351-361.
...
amass<-500 # g, mass of animal (used if the 'monthly' option is checked and DEB model is thus off)
MR_1<-0.013
MR_2<-0.8
MR_3<-0.038
...
Tb<-30.3 # put your guess in here and then run the next line to see what TC that implies
