...
TEMERGE<-17.4 # degrees C, temperature at which animal will move to a basking site *based on Kerr and Bull 2004
...
ctmin<-6.0 # ** degrees C, critical thermal minimum (used by program to determine depth selected when inactive and burrowing) Spellerberg 1972 Temperature tolerances of southeast Australian reptiles examined in relation to reptile thermoregulatory behaviour and distribution. Oecologia (Berl.) 9:23-46.
